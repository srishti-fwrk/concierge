...
@IonicPage()
@Component({
  selector: 'page-paymentnew',
  templateUrl: 'paymentnew.html',
})
export class PaymentnewPage {
  amount;plan;fee;totalpament;paymentnew;txnid;status;trans;
  ...
  //         this.http.post(this.appsetting.myGlobalVar + 'subscriptionPlans/newpayments', serialized, options).map(res => res.json()).subscribe(data => {
  ...
  payment(){
    ...
    var check = this.paymentnew;
       ...
       browser.on('loadstart').subscribe((e) => {
           ...
           console.log(JSON.stringify(redirect_uri));
